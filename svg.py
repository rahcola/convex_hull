...
class SVG:
    ...
    def __draw_axes(self):
        """Add appropriate lines to draw x and y-axes."""
        # x-axis
        self.draw_line(self.vertices.x_min, 0, self.vertices.x_max, 0)
        # y-axis
        self.draw_line(0, self.vertices.y_max, 0, self.vertices.y_min)

    def __to_svg_vertex(self, vertex):
        return (vertex[0] - self.vertices.x_min,
                self.vertecies.y_max - vertex[1])
    ...
    def flush(self):
        ...
        with open(self.filename, 'w') as file:
            ...
            for l in self.lines:
                ...
                file.write('<line x1="%s" y1="%s" x2="%s" y2="%s" stroke="black" stroke-width="0.01"/>\n'\
